...
def load_data(dataset):
    if dataset == "diabetes":
        return pd.read_csv(r"C:\\Users\\ASUS\\OneDrive\\Desktop\\project\\decease_detection\\diabetes.csv")
    elif dataset == "heart":
        return pd.read_csv(r"C:\\Users\\ASUS\\OneDrive\\Desktop\\project\\decease_detection\\heart.csv")
